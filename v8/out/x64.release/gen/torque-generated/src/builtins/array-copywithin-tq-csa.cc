...
TNode<Number> ConvertToRelativeIndex_1(compiler::CodeAssemblerState* state_, TNode<Number> p_index, TNode<Number> p_length) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Number> tmp2;
    USE(tmp2);
    tmp2 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 0);
    TNode<BoolT> tmp3;
    USE(tmp3);
    tmp3 = NumberIsLessThan_75(state_, TNode<Number>{tmp0}, TNode<Number>{tmp2});
  ...
  if (block2.is_used()) {
    ...
    TNode<Number> tmp7;
    USE(tmp7);
    tmp7 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 0);
    TNode<Number> tmp8;
    USE(tmp8);
    tmp8 = Max_81(state_, TNode<Number>{tmp6}, TNode<Number>{tmp7});
  ...
  if (block3.is_used()) {
    ...
    TNode<Number> tmp11;
    USE(tmp11);
    tmp11 = Min_80(state_, TNode<Number>{tmp9}, TNode<Number>{tmp10});
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<Number> tmp10;
    USE(tmp10);
    tmp10 = ConvertToRelativeIndex_1(state_, TNode<Number>{tmp9}, TNode<Number>{tmp6});
    ...
    TNode<Number> tmp14;
    USE(tmp14);
    tmp14 = ConvertToRelativeIndex_1(state_, TNode<Number>{tmp13}, TNode<Number>{tmp6});
    ca_.SetSourcePosition("../../src/builtins/array-copywithin.tq", 35);
    ca_.SetSourcePosition("../../src/builtins/array-copywithin.tq", 36);
    TNode<IntPtrT> tmp15;
    USE(tmp15);
    tmp15 = FromConstexpr8ATintptr17ATconstexpr_int31_150(state_, 2);
    TNode<Object> tmp16;
    USE(tmp16);
  ...
  if (block1.is_used()) {
    ...
    TNode<IntPtrT> tmp31;
    USE(tmp31);
    tmp31 = FromConstexpr8ATintptr17ATconstexpr_int31_150(state_, 2);
    TNode<Object> tmp32;
    USE(tmp32);
  ...
  if (block2.is_used()) {
    ...
    TNode<Number> tmp46;
    USE(tmp46);
    tmp46 = ConvertToRelativeIndex_1(state_, TNode<Number>{tmp45}, TNode<Number>{tmp40});
    ...
    TNode<Number> tmp49;
    USE(tmp49);
    tmp49 = Min_80(state_, TNode<Number>{tmp47}, TNode<Number>{tmp48});
    ca_.SetSourcePosition("../../src/builtins/array-copywithin.tq", 48);
    TNode<Number> tmp50;
    USE(tmp50);
    tmp50 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 1);
    ca_.SetSourcePosition("../../src/builtins/array-copywithin.tq", 50);
    TNode<BoolT> tmp51;
    USE(tmp51);
    tmp51 = NumberIsLessThan_75(state_, TNode<Number>{tmp44}, TNode<Number>{tmp42});
  ...
  if (block5.is_used()) {
    ...
    TNode<BoolT> tmp69;
    USE(tmp69);
    tmp69 = NumberIsLessThan_75(state_, TNode<Number>{tmp60}, TNode<Number>{tmp68});
  ...
  if (block6.is_used()) {
    ...
    TNode<BoolT> tmp86;
    USE(tmp86);
    tmp86 = FromConstexpr6ATbool16ATconstexpr_bool_167(state_, false);
  ...
  if (block3.is_used()) {
    ...
    TNode<Number> tmp119;
    USE(tmp119);
    tmp119 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, -1);
    ...
    TNode<Number> tmp121;
    USE(tmp121);
    tmp121 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 1);
    TNode<Number> tmp122;
    USE(tmp122);
    ...
    TNode<Number> tmp124;
    USE(tmp124);
    tmp124 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 1);
    TNode<Number> tmp125;
    USE(tmp125);
  ...
  if (block10.is_used()) {
    ...
    TNode<Number> tmp156;
    USE(tmp156);
    tmp156 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 0);
    TNode<BoolT> tmp157;
    USE(tmp157);
    tmp157 = NumberIsGreaterThan_77(state_, TNode<Number>{tmp154}, TNode<Number>{tmp156});
  ...
  if (block12.is_used()) {
    ...
    TNode<Smi> tmp210;
    USE(tmp210);
    tmp210 = FromConstexpr14ATLanguageMode24ATconstexpr_LanguageMode_168(state_, LanguageMode::kStrict);
  ...
  if (block13.is_used()) {
    ...
    TNode<Number> tmp230;
    USE(tmp230);
    tmp230 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, 1);
    TNode<Number> tmp231;
    USE(tmp231);
