...
TNode<JSArray> HandleFastAliasedSloppyArgumentsSlice_39(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<JSArgumentsObjectWithLength> p_args, TNode<Smi> p_start, TNode<Smi> p_count, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block5.is_used()) {
    ...
    TNode<IntPtrT> tmp37;
    USE(tmp37);
    tmp37 = Convert8ATintptr17ATconstexpr_int31_1444(state_, SloppyArgumentsElements::kArgumentsIndex);
  ...
  if (block11.is_used()) {
    ...
    TNode<IntPtrT> tmp62;
    USE(tmp62);
    std::tie(tmp61, tmp62) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp53}, TNode<IntPtrT>{tmp60}).Flatten();
  ...
  if (block7.is_used()) {
    ...
    USE(tmp139);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp139 = Cast10FixedArray_1462(state_, TNode<Context>{tmp125}, TNode<Object>{tmp138}, &label0);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp186);
    tmp186 = Convert8ATintptr17ATconstexpr_int31_1444(state_, SloppyArgumentsElements::kContextIndex);
    ca_.SetSourcePosition("../../src/builtins/torque-internal.tq", 51);
    ca_.SetSourcePosition("../../src/builtins/torque-internal.tq", 37);
  ...
  if (block22.is_used()) {
    ...
    USE(tmp213);
    std::tie(tmp212, tmp213) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp204}, TNode<IntPtrT>{tmp211}).Flatten();
  ...
  if (block18.is_used()) {
    ...
    USE(tmp300);
    tmp300 = UnsafeCast7Context_1463(state_, TNode<Context>{tmp284}, TNode<Object>{tmp299});
    ...
    USE(tmp306);
    tmp306 = UnsafeCast10FixedArray_1438(state_, TNode<Context>{tmp284}, TNode<Object>{tmp305});
  ...
  if (block33.is_used()) {
    ...
    USE(tmp385);
    std::tie(tmp384, tmp385) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp376}, TNode<IntPtrT>{tmp383}).Flatten();
  ...
  if (block36.is_used()) {
    ...
    TNode<Smi> tmp537;
    USE(tmp537);
    tmp537 = UnsafeCast5ATSmi_1439(state_, TNode<Context>{tmp519}, TNode<Object>{tmp536});
    TNode<Object> tmp538;
    USE(tmp538);
  ...
  if (block44.is_used()) {
    ...
    USE(tmp598);
    std::tie(tmp597, tmp598) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp589}, TNode<IntPtrT>{tmp596}).Flatten();
  ...
  if (block38.is_used()) {
    ...
    TNode<Object> tmp773;
    USE(tmp773);
    tmp773 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1441(state_, TNode<Context>{tmp754}, TNode<Object>{tmp772});
...
TNode<JSArray> HandleFastSlice_40(compiler::CodeAssemblerState* state_, TNode<NativeContext> p_context, TNode<Object> p_o, TNode<Number> p_startNumber, TNode<Number> p_countNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block5.is_used()) {
    ...
    USE(tmp30);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp30 = Cast20ATFastJSArrayForCopy_1464(state_, TNode<Context>{tmp23}, TNode<Object>{tmp24}, &label0);
  ...
  if (block8.is_used()) {
    ...
    USE(tmp75);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp75 = Cast27JSArgumentsObjectWithLength_1465(state_, TNode<Context>{tmp68}, TNode<Object>{ca_.UncheckedCast<Object>(tmp74)}, &label0);
...
USE(parameter1);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp12);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp12 = Cast20ATFastJSArrayForCopy_1464(state_, TNode<Context>{tmp10}, TNode<Object>{tmp11}, &label0);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp205);
    tmp205 = UnsafeCast15ATNativeContext_1466(state_, TNode<Context>{tmp192}, TNode<Object>{tmp192});
