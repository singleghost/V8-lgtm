...
TNode<BigInt> Convert8ATBigInt13MutableBigInt_258(compiler::CodeAssemblerState* state_, TNode<BigInt> p_i) {
  ...
  if (block0.is_used()) {
    ...
    TNode<BigInt> tmp1;
    USE(tmp1);
    tmp1 = Convert10BigIntBase13MutableBigInt_1484(state_, TNode<BigInt>{tmp0});
    TNode<BigInt> tmp2;
    USE(tmp2);
...
TF_BUILTIN(BigIntAdd, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp3 = Cast8ATBigInt_1485(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp13);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp13 = Cast8ATBigInt_1485(state_, TNode<Context>{tmp8}, TNode<Object>{tmp10}, &label0);
