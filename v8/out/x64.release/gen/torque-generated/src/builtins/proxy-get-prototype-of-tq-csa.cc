...
TF_BUILTIN(ProxyGetPrototypeOf, CodeStubAssembler) {
  ...
  if (block7.is_used()) {
    ...
    USE(tmp14);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp14 = GetMethod_247(state_, TNode<Context>{tmp8}, TNode<Object>{tmp11}, "getPrototypeOf", &label0);
  ...
  if (block9.is_used()) {
    ...
    TNode<BoolT> tmp36;
    USE(tmp36);
    tmp36 = Is10JSReceiver90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1493(state_, TNode<Context>{tmp30}, TNode<Object>{tmp35});
    TNode<BoolT> tmp37;
    USE(tmp37);
  ...
  if (block14.is_used()) {
    ...
    TNode<Object> tmp50;
    USE(tmp50);
    tmp50 = ObjectIsExtensible_313(state_, TNode<Context>{tmp44}, TNode<Object>{tmp47});
    ...
    TNode<BoolT> tmp52;
    USE(tmp52);
    tmp52 = CodeStubAssembler(state_).TaggedEqual(TNode<Object>{tmp50}, TNode<HeapObject>{tmp51});
  ...
  if (block16.is_used()) {
    ...
    TNode<Object> tmp67;
    USE(tmp67);
    tmp67 = ObjectGetPrototypeOf_316(state_, TNode<Context>{tmp60}, TNode<Object>{tmp63});
    ca_.SetSourcePosition("../../src/builtins/proxy-get-prototype-of.tq", 54);
    TNode<BoolT> tmp68;
    USE(tmp68);
    tmp68 = SameValue_244(state_, TNode<Object>{tmp67}, TNode<Object>{tmp65});
  ...
  if (block18.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp77}, MessageTemplate::kProxyGetPrototypeOfNonExtensible);
  }
  ...
  if (block6.is_used()) {
    ...
    TNode<Object> tmp88;
    USE(tmp88);
    tmp88 = ObjectGetPrototypeOf_316(state_, TNode<Context>{tmp85}, TNode<Object>{tmp87});
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp89}, MessageTemplate::kProxyRevoked, "getPrototypeOf");
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp91}, MessageTemplate::kProxyGetPrototypeOfInvalid);
  }
}
