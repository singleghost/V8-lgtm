...
TorqueStructKeyValuePair LoadKeyValuePairNoSideEffects_269(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_MayHaveSideEffects) {
  ...
  if (block4.is_used()) {
    ...
    USE(tmp210);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp210 = Cast10JSReceiver_1433(state_, TNode<Context>{tmp207}, TNode<Object>{ca_.UncheckedCast<Object>(tmp209)}, &label0);
...
TorqueStructKeyValuePair LoadKeyValuePair_270(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  ...
  if (block3.is_used()) {
    ...
    TNode<Smi> tmp14;
    USE(tmp14);
    tmp14 = Convert5ATSmi17ATconstexpr_int31_1435(state_, 0);
    TNode<Object> tmp15;
    USE(tmp15);
    ...
    TNode<Smi> tmp16;
    USE(tmp16);
    tmp16 = Convert5ATSmi17ATconstexpr_int31_1435(state_, 1);
    TNode<Object> tmp17;
    USE(tmp17);
