...
TF_BUILTIN(ProxyRevoke, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp1;
    USE(tmp1);
    tmp1 = FromConstexpr13ATContextSlot23ATconstexpr_ContextSlot_173(state_, Context::MIN_CONTEXT_SLOTS);
    TNode<Object> tmp2;
    USE(tmp2);
    tmp2 = CodeStubAssembler(state_).LoadContextElement(TNode<Context>{tmp0}, TNode<IntPtrT>{tmp1});
  ...
  if (block2.is_used()) {
    ...
    TNode<IntPtrT> tmp11;
    USE(tmp11);
    tmp11 = FromConstexpr13ATContextSlot23ATconstexpr_ContextSlot_173(state_, Context::MIN_CONTEXT_SLOTS);
    CodeStubAssembler(state_).StoreContextElement(TNode<Context>{tmp8}, TNode<IntPtrT>{tmp11}, TNode<Object>{tmp10});
    ca_.SetSourcePosition("../../src/builtins/proxy-revoke.tq", 25);
    TNode<JSProxy> tmp12;
    USE(tmp12);
    tmp12 = UnsafeCast7JSProxy_1495(state_, TNode<Context>{tmp8}, TNode<Object>{tmp9});
    ca_.SetSourcePosition("../../src/builtins/proxy-revoke.tq", 28);
    TNode<IntPtrT> tmp13 = ca_.IntPtrConstant(JSProxy::kTargetOffset);
    USE(tmp13);
    TNode<Oddball> tmp14;
    USE(tmp14);
...
TNode<JSProxy> UnsafeCast7JSProxy_1495(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
