...
TF_BUILTIN(ObjectSetPrototypeOf, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp4 = Cast21UT6ATNull10JSReceiver_1494(state_, TNode<Context>{tmp0}, TNode<Object>{tmp2}, &label0);
...
TNode<HeapObject> Cast21UT6ATNull10JSReceiver_1494(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
