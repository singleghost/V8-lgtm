...
TNode<Smi> LoadElement23ATFastPackedSmiElements5ATSmi_28(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index) {
  ...
  if (block2.is_used()) {
    ...
    TNode<Smi> tmp98;
    USE(tmp98);
    tmp98 = UnsafeCast5ATSmi_1439(state_, TNode<Context>{tmp86}, TNode<Object>{tmp97});
...
TNode<Object> LoadElement26ATFastPackedObjectElements90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_29(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index) {
  ...
  if (block2.is_used()) {
    ...
    TNode<Object> tmp98;
    USE(tmp98);
    tmp98 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1441(state_, TNode<Context>{tmp86}, TNode<Object>{tmp97});
    ca_.Goto(&block1, tmp86, tmp87, tmp88, tmp98);
  }
...
void StoreElement23ATFastPackedSmiElements5ATSmi_31(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, TNode<Smi> p_value) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = UnsafeCast10FixedArray_1438(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1});
...
void StoreElement26ATFastPackedDoubleElements9ATfloat64_33(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, TNode<Float64T> p_value) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    tmp4 = UnsafeCast16FixedDoubleArray_1442(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1});
...
void TryFastPackedArrayReverse_35(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block5.is_used()) {
    ...
    FastPackedArrayReverse23ATFastPackedSmiElements5ATSmi_1459(state_, TNode<Context>{tmp15}, TNode<FixedArrayBase>{tmp20}, TNode<Smi>{tmp21});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 150);
  ...
  if (block8.is_used()) {
    ...
    FastPackedArrayReverse26ATFastPackedObjectElements90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1460(state_, TNode<Context>{tmp28}, TNode<FixedArrayBase>{tmp33}, TNode<Smi>{tmp34});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 154);
  ...
  if (block11.is_used()) {
    ...
    FastPackedArrayReverse26ATFastPackedDoubleElements9ATfloat64_1461(state_, TNode<Context>{tmp41}, TNode<FixedArrayBase>{tmp46}, TNode<Smi>{tmp47});
    ca_.SetSourcePosition("../../src/builtins/array-reverse.tq", 158);
...
TNode<JSArray> Cast13ATFastJSArray_1458(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, Object, Object> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void FastPackedArrayReverse23ATFastPackedSmiElements5ATSmi_1459(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void FastPackedArrayReverse26ATFastPackedObjectElements90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1460(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
...
void FastPackedArrayReverse26ATFastPackedDoubleElements9ATfloat64_1461(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_length) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, FixedArrayBase, Smi, Smi, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
