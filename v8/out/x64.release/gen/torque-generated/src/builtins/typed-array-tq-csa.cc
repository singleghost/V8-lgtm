...
void TypedArrayMerge_391(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_comparefn, TNode<FixedArray> p_source, TNode<Smi> p_from, TNode<Smi> p_middle, TNode<Smi> p_to, TNode<FixedArray> p_target) {
  ...
  if (block16.is_used()) {
    ...
    USE(tmp116);
    std::tie(tmp115, tmp116) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp107}, TNode<IntPtrT>{tmp114}).Flatten();
  ...
  if (block23.is_used()) {
    ...
    USE(tmp260);
    std::tie(tmp259, tmp260) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp251}, TNode<IntPtrT>{tmp258}).Flatten();
  ...
  if (block33.is_used()) {
    ...
    USE(tmp454);
    std::tie(tmp453, tmp454) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp445}, TNode<IntPtrT>{tmp452}).Flatten();
  ...
  if (block29.is_used()) {
    ...
    TNode<Object> tmp556;
    USE(tmp556);
    tmp556 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1441(state_, TNode<Context>{tmp537}, TNode<Object>{tmp555});
  ...
  if (block40.is_used()) {
    ...
    USE(tmp592);
    std::tie(tmp591, tmp592) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp583}, TNode<IntPtrT>{tmp590}).Flatten();
  ...
  if (block36.is_used()) {
    ...
    TNode<Object> tmp699;
    USE(tmp699);
    tmp699 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1441(state_, TNode<Context>{tmp679}, TNode<Object>{tmp698});
  ...
  if (block50.is_used()) {
    ...
    USE(tmp752);
    std::tie(tmp751, tmp752) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp743}, TNode<IntPtrT>{tmp750}).Flatten();
  ...
  if (block57.is_used()) {
    ...
    USE(tmp914);
    std::tie(tmp913, tmp914) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp905}, TNode<IntPtrT>{tmp912}).Flatten();
  ...
  if (block64.is_used()) {
    ...
    USE(tmp1085);
    std::tie(tmp1084, tmp1085) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp1076}, TNode<IntPtrT>{tmp1083}).Flatten();
  ...
  if (block71.is_used()) {
    ...
    USE(tmp1229);
    std::tie(tmp1228, tmp1229) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp1220}, TNode<IntPtrT>{tmp1227}).Flatten();
...
USE(parameter1);
  ...
  if (block17.is_used()) {
    ...
    USE(tmp151);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp151 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1434(state_, TNode<Context>{tmp145}, TNode<Object>{tmp147}, &label0);
  ...
  if (block66.is_used()) {
    ...
    USE(tmp763);
    std::tie(tmp762, tmp763) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp754}, TNode<IntPtrT>{tmp761}).Flatten();
  ...
  if (block73.is_used()) {
    ...
    USE(tmp934);
    std::tie(tmp933, tmp934) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp925}, TNode<IntPtrT>{tmp932}).Flatten();
  ...
  if (block84.is_used()) {
    ...
    USE(tmp1177);
    std::tie(tmp1176, tmp1177) = UnsafeNewReference20UT5ATSmi10HeapObject_1440(state_, TNode<HeapObject>{tmp1168}, TNode<IntPtrT>{tmp1175}).Flatten();
  ...
  if (block80.is_used()) {
    ...
    USE(tmp1319);
    tmp1319 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1441(state_, TNode<Context>{tmp1295}, TNode<Object>{tmp1318});
