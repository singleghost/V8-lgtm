...
TF_BUILTIN(StringToList, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp9);
    tmp9 = UnsafeCast10FixedArray_1438(state_, TNode<Context>{tmp0}, TNode<Object>{tmp8});
...
void GenerateStringAt_338(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_receiver, TNode<Object> p_position, const char* p_methodName, compiler::CodeAssemblerLabel* label_IfInBounds, compiler::TypedCodeAssemblerVariable<String>* label_IfInBounds_parameter_0, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_IfInBounds_parameter_1, compiler::TypedCodeAssemblerVariable<IntPtrT>* label_IfInBounds_parameter_2, compiler::CodeAssemblerLabel* label_IfOutOfBounds) {
  ...
  if (block4.is_used()) {
    ...
    TNode<Smi> tmp17;
    USE(tmp17);
    tmp17 = UnsafeCast5ATSmi_1439(state_, TNode<Context>{tmp12}, TNode<Object>{tmp16});
    TNode<IntPtrT> tmp18;
    USE(tmp18);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    TNode<IntPtrT> tmp7;
    USE(tmp7);
    tmp7 = Convert8ATintptr8ATintptr_1500(state_, TNode<IntPtrT>{tmp2});
...
USE(parameter3);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp42 = Cast6Symbol_1501(state_, TNode<Context>{tmp34}, TNode<Object>{tmp41}, &label0);
  ...
  if (block11.is_used()) {
    ...
    USE(tmp128);
    tmp128 = UnsafeCast10JSReceiver_1486(state_, TNode<Context>{tmp122}, TNode<Object>{tmp124});
    TNode<Map> tmp129;
    USE(tmp129);
    ...
    USE(tmp131);
    tmp131 = UnsafeCast18JSPrimitiveWrapper_1487(state_, TNode<Context>{tmp122}, TNode<Object>{tmp130});
...
TNode<IntPtrT> Convert8ATintptr8ATintptr_1500(compiler::CodeAssemblerState* state_, TNode<IntPtrT> p_i) {
  compiler::CodeAssembler ca_(state_);
...
TNode<Symbol> Cast6Symbol_1501(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
