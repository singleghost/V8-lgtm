...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp10);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp10 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp55);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp55 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1428(state_, TNode<Context>{tmp44}, TNode<Object>{tmp46}, &label0);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp104);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp104 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp92}, TNode<Object>{tmp96}, &label0);
