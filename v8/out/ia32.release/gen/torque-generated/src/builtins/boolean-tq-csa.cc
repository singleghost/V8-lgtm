...
USE(parameter3);
  ...
  if (block2.is_used()) {
    ...
    USE(tmp29);
    tmp29 = UnsafeCast10JSReceiver_1480(state_, TNode<Context>{tmp24}, TNode<Object>{tmp26});
    TNode<Map> tmp30;
    USE(tmp30);
    ...
    USE(tmp32);
    tmp32 = UnsafeCast18JSPrimitiveWrapper_1481(state_, TNode<Context>{tmp24}, TNode<Object>{tmp31});
...
TNode<JSReceiver> UnsafeCast10JSReceiver_1480(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
...
TNode<JSPrimitiveWrapper> UnsafeCast18JSPrimitiveWrapper_1481(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
