...
const char* kBuiltinName_369(compiler::CodeAssemblerState* state_) {
...
TNode<Object> ReduceRightAllElements_370(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_initialValue) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block2.is_used()) {
    ...
    TNode<Smi> tmp51;
    USE(tmp51);
    tmp51 = FromConstexpr5ATSmi17ATconstexpr_int31_154(state_, 1);
    TNode<Smi> tmp52;
    USE(tmp52);
    tmp52 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp50}, TNode<Smi>{tmp51});
  ...
  if (block9.is_used()) {
    ...
    TNode<Smi> tmp63;
    USE(tmp63);
    tmp63 = FromConstexpr5ATSmi17ATconstexpr_int31_154(state_, 0);
    TNode<BoolT> tmp64;
    USE(tmp64);
  ...
  if (block7.is_used()) {
    ...
    TNode<IntPtrT> tmp75 = ca_.IntPtrConstant(JSArrayBufferView::kBufferOffset);
    USE(tmp75);
    TNode<JSArrayBuffer>tmp76 = CodeStubAssembler(state_).LoadReference<JSArrayBuffer>(CodeStubAssembler::Reference{tmp69, tmp75});
    TNode<BoolT> tmp77;
    USE(tmp77);
    tmp77 = CodeStubAssembler(state_).IsDetachedBuffer(TNode<JSArrayBuffer>{tmp76});
  ...
  if (block15.is_used()) {
    ...
    USE(tmp98);
    tmp98 = (TNode<JSTypedArray>{tmp92});
  ...
  if (block11.is_used()) {
    ...
    TNode<Object> tmp129 = CodeStubAssembler(state_).CallBuiltinPointer(Builtins::CallableFor(ca_.isolate(),ExampleBuiltinForTorqueFunctionPointerType(1)).descriptor(), tmp125, tmp119, tmp124, tmp128); 
    USE(tmp129);
  ...
  if (block16.is_used()) {
    ...
    USE(tmp144);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp144 = Cast9ATTheHole_88(state_, TNode<Object>{tmp138}, &label0);
  ...
  if (block21.is_used()) {
    ...
    TNode<Object> tmp205;
    USE(tmp205);
    tmp205 = CodeStubAssembler(state_).Call(TNode<Context>{tmp198}, TNode<JSReceiver>{tmp199}, TNode<Object>{tmp200}, TNode<Object>{tmp201}, TNode<Object>{tmp202}, TNode<Object>{tmp203}, TNode<Object>{tmp204});
    ca_.SetSourcePosition("../../src/builtins/typed-array-reduceright.tq", 23);
  ...
  if (block10.is_used()) {
    ...
    TNode<Smi> tmp229;
    USE(tmp229);
    tmp229 = CodeStubAssembler(state_).SmiSub(TNode<Smi>{tmp227}, TNode<Smi>{tmp228});
  ...
  if (block8.is_used()) {
    ...
    TNode<Oddball> tmp240;
    USE(tmp240);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp240 = Cast9ATTheHole_88(state_, TNode<Object>{tmp238}, &label0);
  ...
  if (block24.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp252}, MessageTemplate::kReduceNoInitial, kBuiltinName_369(state_));
  }

  if (block23.is_used()) {
    TNode<Context> tmp264;
    TNode<JSTypedArray> tmp265;
    TNode<JSReceiver> tmp266;
    TNode<Object> tmp267;
    TNode<JSTypedArray> tmp268;
    TNode<JSTypedArray> tmp269;
    TNode<BuiltinPtr> tmp270;
    TNode<Smi> tmp271;
    TNode<Object> tmp272;
    TNode<Object> tmp273;
...
USE(parameter1);
  ...
  if (block15.is_used()) {
    ...
    TNode<Object> tmp94;
    USE(tmp94);
    tmp94 = ReduceRightAllElements_370(state_, TNode<Context>{tmp88}, TNode<JSTypedArray>{tmp91}, TNode<JSReceiver>{tmp92}, TNode<Object>{tmp93});
  ...
  if (block4.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp105}, MessageTemplate::kNotTypedArray, kBuiltinName_369(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp110}, MessageTemplate::kDetachedOperation, kBuiltinName_369(state_));
  }
}
