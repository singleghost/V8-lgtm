...
const char* kBuiltinName_363(compiler::CodeAssemblerState* state_) {
...
TNode<Number> FindIndexAllElements_364(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSTypedArray, JSReceiver, Object, Number> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 13);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 16);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 17);
    TNode<Smi> tmp51;
    USE(tmp51);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 19);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 20);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 20);
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 22);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 23);
    TNode<BoolT> tmp151;
    USE(tmp151);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 24);
    ca_.Goto(&block1, tmp152, tmp153, tmp154, tmp155, tmp160);
  }
  ...
  if (block8.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 27);
    TNode<Number> tmp194;
    USE(tmp194);
    tmp194 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, -1);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 10);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 37);
    TNode<JSTypedArray> tmp5;
    USE(tmp5);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 39);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 41);
    TNode<IntPtrT> tmp35;
    USE(tmp35);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 42);
    TNode<IntPtrT> tmp55;
    USE(tmp55);
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 43);
    TNode<Number> tmp57;
    USE(tmp57);
    tmp57 = FindIndexAllElements_364(state_, TNode<Context>{tmp49}, TNode<JSTypedArray>{tmp52}, TNode<JSReceiver>{tmp54}, TNode<Object>{tmp56});
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 46);
    TNode<IntPtrT> tmp63;
    USE(tmp63);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 49);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_363(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-findindex.tq", 52);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_363(state_));
  }
}
