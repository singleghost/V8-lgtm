...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 34);
    CodeStubAssembler(state_).Unreachable();
  }
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp8);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp8 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1}, &label0);
  ...
  if (block1.is_used()) {
    ...
    USE(tmp45);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp45 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1428(state_, TNode<Context>{tmp36}, TNode<Object>{tmp38}, &label0);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 51);
    TNode<Number> tmp131;
    USE(tmp131);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 59);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 63);
...
TF_BUILTIN(ArrayFindIndexLoopContinuation, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    TNode<Number> tmp6;
    ca_.Bind(&block0, &tmp0, &tmp1, &tmp2, &tmp3, &tmp4, &tmp5, &tmp6);
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 72);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 78);
    TNode<Object> tmp24;
    USE(tmp24);
  ...
  if (block2.is_used()) {
    ...
    TNode<Smi> tmp65;
    USE(tmp65);
    tmp65 = Convert5ATSmi17ATconstexpr_int31_1429(state_, -1);
    CodeStubAssembler(state_).Return(tmp65);
  }
}

TNode<Number> FastArrayFindIndex_6(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o, TNode<Number> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_0) {
  ...
  if (block12.is_used()) {
    ...
    TNode<Number> tmp526;
    USE(tmp526);
    tmp526 = FromConstexpr20UT5ATSmi10HeapNumber17ATconstexpr_int31_160(state_, -1);
...
USE(parameter1);
  ...
  compiler::CodeAssemblerParameterizedLabel<RawPtrT, RawPtrT, IntPtrT, Context, Object, JSReceiver, Number, JSReceiver, Object, JSReceiver, Number, JSReceiver, Object, Number> block13(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    TNode<Object> tmp5;
    USE(tmp5);
    tmp5 = RequireObjectCoercible_243(state_, TNode<Context>{tmp3}, TNode<Object>{tmp4}, "Array.prototype.findIndex");
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 127);
    TNode<JSReceiver> tmp6;
    USE(tmp6);
    tmp6 = CodeStubAssembler(state_).ToObject_Inline(TNode<Context>{tmp3}, TNode<Object>{tmp4});
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 130);
    TNode<Number> tmp7;
    USE(tmp7);
    tmp7 = GetLengthProperty_246(state_, TNode<Context>{tmp3}, TNode<Object>{tmp6});
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 133);
    TNode<IntPtrT> tmp8;
    USE(tmp8);
  ...
  if (block3.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 134);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 137);
    TNode<IntPtrT> tmp24;
    USE(tmp24);
  ...
  if (block5.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 140);
    TNode<IntPtrT> tmp44;
    USE(tmp44);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 144);
    TNode<Number> tmp83;
    USE(tmp83);
    compiler::TypedCodeAssemblerVariable<Smi> result_0_0(&ca_);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp83 = FastArrayFindIndex_6(state_, TNode<Context>{tmp77}, TNode<JSReceiver>{tmp79}, TNode<Number>{tmp80}, TNode<JSReceiver>{tmp81}, TNode<Object>{tmp82}, &label0, &result_0_0);
  ...
  if (block12.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 149);
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 148);
    TNode<Number> tmp122;
    tmp122 = TORQUE_CAST(CodeStubAssembler(state_).CallBuiltin(Builtins::kArrayFindIndexLoopContinuation, tmp115, tmp117, tmp119, tmp120, tmp117, tmp121, tmp118));
    USE(tmp122);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/array-findindex.tq", 153);
...
TNode<Smi> Convert5ATSmi17ATconstexpr_int31_1429(compiler::CodeAssemblerState* state_, int31_t p_i) {
  compiler::CodeAssembler ca_(state_);
  ...
  if (block0.is_used()) {
    ...
    TNode<Smi> tmp0;
    USE(tmp0);
    tmp0 = FromConstexpr5ATSmi17ATconstexpr_int31_154(state_, p_i);
