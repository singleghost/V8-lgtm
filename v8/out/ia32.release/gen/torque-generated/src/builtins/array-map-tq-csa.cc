...
USE(parameter1);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp77);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp77 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp68}, TNode<Object>{tmp72}, &label0);
...
USE(parameter1);
  ...
  if (block5.is_used()) {
    ...
    USE(tmp86);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp86 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp76}, TNode<Object>{tmp80}, &label0);
...
TNode<JSArray> FastArrayMap_25(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSArray> p_fastO, TNode<Smi> p_len, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg, compiler::CodeAssemblerLabel* label_Bailout, compiler::TypedCodeAssemblerVariable<JSArray>* label_Bailout_parameter_0, compiler::TypedCodeAssemblerVariable<Smi>* label_Bailout_parameter_1) {
  ...
  if (block39.is_used()) {
    ...
    USE(tmp441);
    std::tie(tmp440, tmp441) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp432}, TNode<IntPtrT>{tmp439}).Flatten();
  ...
  if (block50.is_used()) {
    ...
    USE(tmp719);
    std::tie(tmp718, tmp719) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp710}, TNode<IntPtrT>{tmp717}).Flatten();
  ...
  if (block57.is_used()) {
    ...
    USE(tmp950);
    std::tie(tmp949, tmp950) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp941}, TNode<IntPtrT>{tmp948}).Flatten();
  ...
  if (block83.is_used()) {
    ...
    USE(tmp1602);
    std::tie(tmp1601, tmp1602) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp1593}, TNode<IntPtrT>{tmp1600}).Flatten();
  ...
  if (block79.is_used()) {
    ...
    USE(tmp1769);
    tmp1769 = UnsafeCast30UT5ATSmi9ATTheHole10HeapNumber_1448(state_, TNode<Context>{tmp1753}, TNode<Object>{tmp1768});
  ...
  if (block94.is_used()) {
    ...
    USE(tmp1873);
    std::tie(tmp1872, tmp1873) = UnsafeNewReference9ATfloat64_1449(state_, TNode<HeapObject>{tmp1864}, TNode<IntPtrT>{tmp1871}).Flatten();
  ...
  if (block119.is_used()) {
    ...
    USE(tmp2555);
    std::tie(tmp2554, tmp2555) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp2546}, TNode<IntPtrT>{tmp2553}).Flatten();
  ...
  if (block115.is_used()) {
    ...
    USE(tmp2717);
    tmp2717 = UnsafeCast30UT5ATSmi9ATTheHole10HeapNumber_1448(state_, TNode<Context>{tmp2701}, TNode<Object>{tmp2716});
    ca_.SetSourcePosition("../../src/builtins/array-map.tq", 132);
  ...
  if (block130.is_used()) {
    ...
    USE(tmp2818);
    std::tie(tmp2817, tmp2818) = UnsafeNewReference9ATfloat64_1449(state_, TNode<HeapObject>{tmp2809}, TNode<IntPtrT>{tmp2816}).Flatten();
...
USE(parameter1);
  ...
  if (block16.is_used()) {
    ...
    USE(tmp107);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp107 = Cast20ATFastJSArrayForRead_1450(state_, TNode<Context>{tmp99}, TNode<Object>{tmp100}, &label0);
...
TNode<Object> UnsafeCast30UT5ATSmi9ATTheHole10HeapNumber_1448(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
...
TNode<JSArray> Cast20ATFastJSArrayForRead_1450(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, Object> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
