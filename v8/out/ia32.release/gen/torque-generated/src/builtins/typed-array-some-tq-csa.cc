...
const char* kBuiltinName_374(compiler::CodeAssemblerState* state_) {
...
TNode<Oddball> SomeAllElements_375(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSTypedArray, JSReceiver, Object, Oddball> block20(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 13);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 16);
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 17);
    TNode<Smi> tmp51;
    USE(tmp51);
  ...
  if (block15.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 19);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 20);
  ...
  if (block16.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 20);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 22);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 23);
    TNode<BoolT> tmp151;
    USE(tmp151);
  ...
  if (block18.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 24);
    TNode<Oddball> tmp163;
    USE(tmp163);
    tmp163 = True_65(state_);
    ca_.Goto(&block1, tmp152, tmp153, tmp154, tmp155, tmp163);
  }
  ...
  if (block19.is_used()) {
    ...
    TNode<Object> tmp173;
    TNode<Object> tmp174;
    ca_.Bind(&block19, &tmp164, &tmp165, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170, &tmp171, &tmp172, &tmp173, &tmp174);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 17);
    ca_.Goto(&block10, tmp164, tmp165, tmp166, tmp167, tmp168, tmp169, tmp170, tmp171, tmp172);
  }
  ...
  if (block10.is_used()) {
    ...
    TNode<Smi> tmp184;
    USE(tmp184);
    tmp184 = FromConstexpr5ATSmi17ATconstexpr_int31_154(state_, 1);
    TNode<Smi> tmp185;
    USE(tmp185);
    tmp185 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp183}, TNode<Smi>{tmp184});
    ca_.Goto(&block9, tmp175, tmp176, tmp177, tmp178, tmp179, tmp180, tmp181, tmp182, tmp185);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<Smi> tmp193;
    TNode<Smi> tmp194;
    ca_.Bind(&block8, &tmp186, &tmp187, &tmp188, &tmp189, &tmp190, &tmp191, &tmp192, &tmp193, &tmp194);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 27);
    TNode<Oddball> tmp195;
    USE(tmp195);
    tmp195 = False_66(state_);
    ca_.Goto(&block1, tmp186, tmp187, tmp188, tmp189, tmp195);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp196, &tmp197, &tmp198, &tmp199, &tmp200);
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 10);
    ca_.Goto(&block20, tmp196, tmp197, tmp198, tmp199, tmp200);
  }
    ...
    ca_.Bind(&block20, &tmp201, &tmp202, &tmp203, &tmp204, &tmp205);
  return TNode<Oddball>{tmp205};
}
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 37);
    TNode<JSTypedArray> tmp5;
    USE(tmp5);
    compiler::CodeAssemblerLabel label0(&ca_);
  ...
  if (block7.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 39);
  ...
  if (block9.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 41);
    TNode<IntPtrT> tmp35;
    USE(tmp35);
    ...
    USE(tmp37);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp37 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1428(state_, TNode<Context>{tmp30}, TNode<Object>{tmp36}, &label0);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 42);
    TNode<IntPtrT> tmp55;
    USE(tmp55);
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 43);
    TNode<Oddball> tmp57;
    USE(tmp57);
    tmp57 = SomeAllElements_375(state_, TNode<Context>{tmp49}, TNode<JSTypedArray>{tmp52}, TNode<JSReceiver>{tmp54}, TNode<Object>{tmp56});
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 46);
    TNode<IntPtrT> tmp63;
    USE(tmp63);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 49);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_374(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-some.tq", 52);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_374(state_));
  }
}
