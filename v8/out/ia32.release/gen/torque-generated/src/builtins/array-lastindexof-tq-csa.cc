...
TNode<Object> LoadWithHoleCheck10FixedArray_19(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_index, compiler::CodeAssemblerLabel* label_IfHole) {
  ...
  if (block11.is_used()) {
    ...
    TNode<Object> tmp110;
    USE(tmp110);
    tmp110 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1435(state_, TNode<Context>{tmp105}, TNode<Object>{tmp109});
...
TNode<Object> TryFastArrayLastIndexOf_22(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_receiver, TNode<Object> p_searchElement, TNode<Number> p_from, compiler::CodeAssemblerLabel* label_Slow) {
  ...
  if (block9.is_used()) {
    ...
    TNode<Smi> tmp60;
    USE(tmp60);
    tmp60 = FastArrayLastIndexOf10FixedArray_1446(state_, TNode<Context>{tmp52}, TNode<JSArray>{tmp56}, TNode<Smi>{tmp58}, TNode<Object>{tmp54});
  ...
  if (block10.is_used()) {
    ...
    TNode<Smi> tmp69;
    USE(tmp69);
    tmp69 = FastArrayLastIndexOf16FixedDoubleArray_1447(state_, TNode<Context>{tmp61}, TNode<JSArray>{tmp65}, TNode<Smi>{tmp67}, TNode<Object>{tmp63});
