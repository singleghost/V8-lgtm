...
TNode<FixedDoubleArray> Extract16FixedDoubleArray_43(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArrayBase> p_elements, TNode<Smi> p_first, TNode<Smi> p_count, TNode<Smi> p_capacity) {
  ...
  if (block3.is_used()) {
    ...
    USE(tmp20);
    tmp20 = UnsafeCast16FixedDoubleArray_1436(state_, TNode<Context>{tmp14}, TNode<Object>{tmp19});
...
TNode<Object> FastArraySplice_44(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSReceiver> p_o, TNode<Number> p_originalLengthNumber, TNode<Number> p_actualStartNumber, TNode<Smi> p_insertCount, TNode<Number> p_actualDeleteCountNumber, compiler::CodeAssemblerLabel* label_Bailout) {
  ...
  if (block28.is_used()) {
    ...
    USE(tmp372);
    tmp372 = UnsafeCast10HeapObject_1442(state_, TNode<Context>{tmp352}, TNode<Object>{tmp371});
  ...
  if (block47.is_used()) {
    ...
    FastSplice16FixedDoubleArray20UT5ATSmi10HeapNumber_1462(state_, TNode<Context>{tmp835}, TorqueStructArguments{TNode<RawPtrT>{tmp836}, TNode<RawPtrT>{tmp837}, TNode<IntPtrT>{tmp838}}, TNode<JSArray>{tmp849}, TNode<Smi>{tmp853}, TNode<Smi>{tmp848}, TNode<Smi>{tmp845}, TNode<Smi>{tmp842}, TNode<Smi>{tmp846});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 168);
...
void FastSplice10FixedArray90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1461(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    tmp42 = UnsafeCast10FixedArray_1432(state_, TNode<Context>{tmp28}, TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 68);
    DoMoveElements10FixedArray_1513(state_, TNode<FixedArray>{tmp42}, TNode<Smi>{tmp39}, TNode<Smi>{tmp40}, TNode<Smi>{tmp41});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 71);
    TNode<FixedArray> tmp43;
    USE(tmp43);
    tmp43 = UnsafeCast10FixedArray_1432(state_, TNode<Context>{tmp28}, TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 70);
    StoreHoles10FixedArray_1514(state_, TNode<FixedArray>{tmp43}, TNode<Smi>{tmp34}, TNode<Smi>{tmp33});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 66);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp90);
    tmp90 = UnsafeCast10FixedArray_1432(state_, TNode<Context>{tmp76}, TNode<Object>{tmp86});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 75);
    DoMoveElements10FixedArray_1513(state_, TNode<FixedArray>{tmp90}, TNode<Smi>{tmp87}, TNode<Smi>{tmp88}, TNode<Smi>{tmp89});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 74);
  ...
  if (block12.is_used()) {
    ...
    USE(tmp129);
    tmp129 = UnsafeCast10FixedArray_1432(state_, TNode<Context>{tmp113}, TNode<Object>{tmp123});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 86);
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 84);
    DoCopyElements10FixedArray_1515(state_, TNode<FixedArray>{tmp128}, TNode<Smi>{tmp124}, TNode<FixedArray>{tmp129}, TNode<Smi>{tmp125}, TNode<Smi>{tmp126});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 83);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp213);
    tmp213 = UnsafeCast10FixedArray_1432(state_, TNode<Context>{tmp200}, TNode<Object>{tmp212});
  ...
  if (block16.is_used()) {
    ...
    TNode<Object> tmp245;
    USE(tmp245);
    tmp245 = UnsafeCast90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1435(state_, TNode<Context>{tmp229}, TNode<Object>{tmp242});
...
void FastSplice16FixedDoubleArray20UT5ATSmi10HeapNumber_1462(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TorqueStructArguments p_args, TNode<JSArray> p_a, TNode<Smi> p_length, TNode<Smi> p_newLength, TNode<Smi> p_actualStart, TNode<Smi> p_insertCount, TNode<Smi> p_actualDeleteCount) {
  compiler::CodeAssembler ca_(state_);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi> block0(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi> block2(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  compiler::CodeAssemblerParameterizedLabel<Context, RawPtrT, RawPtrT, IntPtrT, JSArray, Smi, Smi, Smi, Smi, Smi, FixedArrayBase, Smi, Smi, Smi> block4(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block4.is_used()) {
    ...
    USE(tmp42);
    tmp42 = UnsafeCast16FixedDoubleArray_1436(state_, TNode<Context>{tmp28}, TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 68);
    DoMoveElements16FixedDoubleArray_1516(state_, TNode<FixedDoubleArray>{tmp42}, TNode<Smi>{tmp39}, TNode<Smi>{tmp40}, TNode<Smi>{tmp41});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 71);
    TNode<FixedDoubleArray> tmp43;
    USE(tmp43);
    tmp43 = UnsafeCast16FixedDoubleArray_1436(state_, TNode<Context>{tmp28}, TNode<Object>{tmp38});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 70);
    StoreHoles16FixedDoubleArray_1517(state_, TNode<FixedDoubleArray>{tmp43}, TNode<Smi>{tmp34}, TNode<Smi>{tmp33});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 66);
    ca_.Goto(&block6, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41);
  }
  ...
  if (block9.is_used()) {
    ...
    USE(tmp90);
    tmp90 = UnsafeCast16FixedDoubleArray_1436(state_, TNode<Context>{tmp76}, TNode<Object>{tmp86});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 75);
    DoMoveElements16FixedDoubleArray_1516(state_, TNode<FixedDoubleArray>{tmp90}, TNode<Smi>{tmp87}, TNode<Smi>{tmp88}, TNode<Smi>{tmp89});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 74);
    ca_.Goto(&block11, tmp76, tmp77, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83, tmp84, tmp85, tmp86, tmp87, tmp88, tmp89);
  }
  ...
  if (block12.is_used()) {
    ...
    USE(tmp129);
    tmp129 = UnsafeCast16FixedDoubleArray_1436(state_, TNode<Context>{tmp113}, TNode<Object>{tmp123});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 86);
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 84);
    DoCopyElements16FixedDoubleArray_1518(state_, TNode<FixedDoubleArray>{tmp128}, TNode<Smi>{tmp124}, TNode<FixedDoubleArray>{tmp129}, TNode<Smi>{tmp125}, TNode<Smi>{tmp126});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 83);
    ca_.Goto(&block13, tmp113, tmp114, tmp115, tmp116, tmp117, tmp118, tmp119, tmp120, tmp121, tmp122, tmp123, tmp124, tmp125, tmp126, tmp127, tmp128);
  }
  ...
  if (block14.is_used()) {
    ...
    USE(tmp213);
    tmp213 = UnsafeCast16FixedDoubleArray_1436(state_, TNode<Context>{tmp200}, TNode<Object>{tmp212});
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 95);
    ca_.SetSourcePosition("../../src/builtins/array-splice.tq", 97);
    TNode<IntPtrT> tmp214;
    USE(tmp214);
  ...
  if (block16.is_used()) {
    ...
    TNode<Number> tmp245;
    USE(tmp245);
    tmp245 = UnsafeCast20UT5ATSmi10HeapNumber_1519(state_, TNode<Context>{tmp229}, TNode<Object>{tmp242});
...
void DoMoveElements10FixedArray_1513(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_elements, TNode<Smi> p_dstIndex, TNode<Smi> p_srcIndex, TNode<Smi> p_count) {
  compiler::CodeAssembler ca_(state_);
...
void StoreHoles10FixedArray_1514(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_elements, TNode<Smi> p_holeStartIndex, TNode<Smi> p_holeEndIndex) {
  compiler::CodeAssembler ca_(state_);
...
void DoCopyElements10FixedArray_1515(compiler::CodeAssemblerState* state_, TNode<FixedArray> p_dstElements, TNode<Smi> p_dstIndex, TNode<FixedArray> p_srcElements, TNode<Smi> p_srcIndex, TNode<Smi> p_count) {
  compiler::CodeAssembler ca_(state_);
...
void DoMoveElements16FixedDoubleArray_1516(compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_dstIndex, TNode<Smi> p_srcIndex, TNode<Smi> p_count) {
  compiler::CodeAssembler ca_(state_);
...
void StoreHoles16FixedDoubleArray_1517(compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_elements, TNode<Smi> p_holeStartIndex, TNode<Smi> p_holeEndIndex) {
  compiler::CodeAssembler ca_(state_);
...
void DoCopyElements16FixedDoubleArray_1518(compiler::CodeAssemblerState* state_, TNode<FixedDoubleArray> p_dstElements, TNode<Smi> p_dstIndex, TNode<FixedDoubleArray> p_srcElements, TNode<Smi> p_srcIndex, TNode<Smi> p_count) {
  compiler::CodeAssembler ca_(state_);
...
TNode<Number> UnsafeCast20UT5ATSmi10HeapNumber_1519(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o) {
  compiler::CodeAssembler ca_(state_);
