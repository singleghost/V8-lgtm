...
USE(parameter1);
  ...
  if (block14.is_used()) {
    ...
    USE(tmp106);
    std::tie(tmp105, tmp106) = UnsafeNewReference9ATfloat64_1449(state_, TNode<HeapObject>{tmp97}, TNode<IntPtrT>{tmp104}).Flatten();
  ...
  if (block35.is_used()) {
    ...
    USE(tmp407);
    std::tie(tmp406, tmp407) = UnsafeNewReference9ATfloat64_1449(state_, TNode<HeapObject>{tmp398}, TNode<IntPtrT>{tmp405}).Flatten();
