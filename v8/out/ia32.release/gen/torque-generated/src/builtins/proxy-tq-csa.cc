...
TNode<BoolT> IsRevokedProxy_321(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_o) {
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/proxy.tq", 14);
    TNode<IntPtrT> tmp16 = ca_.IntPtrConstant(JSProxy::kHandlerOffset);
    USE(tmp16);
    ...
    USE(tmp18);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp18 = Cast10JSReceiver_142(state_, TNode<HeapObject>{tmp17}, &label0);
  ...
  if (block7.is_used()) {
    ...
    TNode<BoolT> tmp31;
    USE(tmp31);
    tmp31 = FromConstexpr6ATbool16ATconstexpr_bool_167(state_, true);
  ...
  if (block6.is_used()) {
    ...
    TNode<BoolT> tmp36;
    USE(tmp36);
    tmp36 = FromConstexpr6ATbool16ATconstexpr_bool_167(state_, false);
  ...
  if (block1.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/proxy.tq", 12);
