...
TF_BUILTIN(ProxyGetPrototypeOf, CodeStubAssembler) {
  ...
  if (block9.is_used()) {
    ...
    TNode<BoolT> tmp36;
    USE(tmp36);
    tmp36 = Is10JSReceiver90UT8ATBigInt7ATFalse6ATNull5ATSmi6ATTrue11ATUndefined10HeapNumber10JSReceiver6String6Symbol_1487(state_, TNode<Context>{tmp30}, TNode<Object>{tmp35});
    TNode<BoolT> tmp37;
    USE(tmp37);
