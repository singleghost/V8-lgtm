...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    tmp6 = Cast13ATConstructor_1451(state_, TNode<Context>{tmp3}, TNode<Object>{tmp4}, &label0);
...
TNode<JSReceiver> Cast13ATConstructor_1451(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<Object> p_o, compiler::CodeAssemblerLabel* label_CastError) {
