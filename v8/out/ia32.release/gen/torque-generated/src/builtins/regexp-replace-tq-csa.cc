...
void RegExpReplaceCallableNoExplicitCaptures_326(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block10.is_used()) {
    ...
    TNode<IntPtrT> tmp50;
    USE(tmp50);
    std::tie(tmp49, tmp50) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp41}, TNode<IntPtrT>{tmp48}).Flatten();
  ...
  if (block24.is_used()) {
    ...
    USE(tmp207);
    std::tie(tmp206, tmp207) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp198}, TNode<IntPtrT>{tmp205}).Flatten();
  ...
  if (block20.is_used()) {
    ...
    TNode<Smi> tmp295;
    USE(tmp295);
    tmp295 = UnsafeCast5ATSmi_1433(state_, TNode<Context>{tmp278}, TNode<Object>{tmp294});
  ...
  if (block35.is_used()) {
    ...
    USE(tmp369);
    std::tie(tmp368, tmp369) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp360}, TNode<IntPtrT>{tmp367}).Flatten();
...
void RegExpReplaceCallableWithExplicitCaptures_327(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<FixedArray> p_matchesElements, TNode<IntPtrT> p_matchesLength, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block8.is_used()) {
    ...
    USE(tmp110);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp110 = Cast7JSArray_1472(state_, TNode<Context>{tmp97}, TNode<Object>{tmp109}, &label0);
  ...
  if (block21.is_used()) {
    ...
    USE(tmp167);
    std::tie(tmp166, tmp167) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp158}, TNode<IntPtrT>{tmp165}).Flatten();
...
TNode<String> RegExpReplaceFastGlobalCallable_328(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string, TNode<JSReceiver> p_replaceFn) {
  ...
  if (block3.is_used()) {
    ...
    TNode<JSArray> tmp28;
    USE(tmp28);
    tmp28 = UnsafeCast7JSArray_1430(state_, TNode<Context>{tmp21}, TNode<Object>{tmp27});
  ...
  if (block4.is_used()) {
    ...
    USE(tmp71);
    tmp71 = UnsafeCast10FixedArray_1432(state_, TNode<Context>{tmp59}, TNode<Object>{tmp70});
...
TF_BUILTIN(RegExpReplace, CodeStubAssembler) {
  ...
  if (block0.is_used()) {
    ...
    USE(tmp4);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp4 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1428(state_, TNode<Context>{tmp0}, TNode<Object>{tmp3}, &label0);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp9);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp9 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp3}, TNode<Object>{tmp4}, &label0);
