...
const char* kBuiltinName_365(compiler::CodeAssemblerState* state_) {
...
TNode<Oddball> ForEachAllElements_366(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSTypedArray> p_array, TNode<JSReceiver> p_callbackfn, TNode<Object> p_thisArg) {
  compiler::CodeAssembler ca_(state_);
  ...
  compiler::CodeAssemblerParameterizedLabel<Context, JSTypedArray, JSReceiver, Object, Oddball> block18(&ca_, compiler::CodeAssemblerLabel::kNonDeferred);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 16);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 20);
  ...
  if (block17.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 17);
    ca_.Goto(&block10, tmp134, tmp135, tmp136, tmp137, tmp138, tmp139, tmp140, tmp141, tmp142);
  }
  ...
  if (block10.is_used()) {
    ...
    TNode<Smi> tmp158;
    TNode<Smi> tmp159;
    ca_.Bind(&block10, &tmp151, &tmp152, &tmp153, &tmp154, &tmp155, &tmp156, &tmp157, &tmp158, &tmp159);
    TNode<Smi> tmp160;
    USE(tmp160);
    tmp160 = FromConstexpr5ATSmi17ATconstexpr_int31_154(state_, 1);
    TNode<Smi> tmp161;
    USE(tmp161);
    tmp161 = CodeStubAssembler(state_).SmiAdd(TNode<Smi>{tmp159}, TNode<Smi>{tmp160});
    ca_.Goto(&block9, tmp151, tmp152, tmp153, tmp154, tmp155, tmp156, tmp157, tmp158, tmp161);
  }
  ...
  if (block8.is_used()) {
    ...
    TNode<Smi> tmp169;
    TNode<Smi> tmp170;
    ca_.Bind(&block8, &tmp162, &tmp163, &tmp164, &tmp165, &tmp166, &tmp167, &tmp168, &tmp169, &tmp170);
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 23);
    TNode<Oddball> tmp171;
    USE(tmp171);
    tmp171 = Undefined_64(state_);
    ca_.Goto(&block1, tmp162, tmp163, tmp164, tmp165, tmp171);
  }
  ...
  if (block1.is_used()) {
    ...
    ca_.Bind(&block1, &tmp172, &tmp173, &tmp174, &tmp175, &tmp176);
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 10);
    ca_.Goto(&block18, tmp172, tmp173, tmp174, tmp175, tmp176);
  }
    ...
    ca_.Bind(&block18, &tmp177, &tmp178, &tmp179, &tmp180, &tmp181);
  return TNode<Oddball>{tmp181};
}
...
USE(parameter1);
  ...
  if (block11.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 39);
    TNode<IntPtrT> tmp55;
    USE(tmp55);
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 40);
    TNode<Oddball> tmp57;
    USE(tmp57);
    tmp57 = ForEachAllElements_366(state_, TNode<Context>{tmp49}, TNode<JSTypedArray>{tmp52}, TNode<JSReceiver>{tmp54}, TNode<Object>{tmp56});
  ...
  if (block6.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 43);
    TNode<IntPtrT> tmp63;
    USE(tmp63);
  ...
  if (block4.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 46);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp68}, MessageTemplate::kNotTypedArray, kBuiltinName_365(state_));
  }
  ...
  if (block2.is_used()) {
    ...
    ca_.SetSourcePosition("../../src/builtins/typed-array-foreach.tq", 49);
    CodeStubAssembler(state_).ThrowTypeError(TNode<Context>{tmp73}, MessageTemplate::kDetachedOperation, kBuiltinName_365(state_));
  }
}
