...
USE(parameter1);
  ...
  if (block9.is_used()) {
    ...
    USE(tmp84);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp84 = Cast71UT19ATCallableApiObject17ATCallableJSProxy15JSBoundFunction10JSFunction_1428(state_, TNode<Context>{tmp77}, TNode<Object>{tmp83}, &label0);
  ...
  if (block37.is_used()) {
    ...
    USE(tmp428);
    std::tie(tmp427, tmp428) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp419}, TNode<IntPtrT>{tmp426}).Flatten();
