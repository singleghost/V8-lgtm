...
TNode<Object> RegExpPrototypeSearchBodyFast_330(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSRegExp> p_regexp, TNode<String> p_string) {
  ...
  if (block4.is_used()) {
    ...
    TNode<IntPtrT> tmp23;
    USE(tmp23);
    tmp23 = Convert8ATintptr17ATconstexpr_int31_1438(state_, RegExpMatchInfo::kFirstCaptureIndex);
  ...
  if (block10.is_used()) {
    ...
    TNode<IntPtrT> tmp45;
    USE(tmp45);
    std::tie(tmp44, tmp45) = UnsafeNewReference20UT5ATSmi10HeapObject_1434(state_, TNode<HeapObject>{tmp36}, TNode<IntPtrT>{tmp43}).Flatten();
  ...
  if (block6.is_used()) {
    ...
    TNode<Smi> tmp107;
    USE(tmp107);
    tmp107 = UnsafeCast5ATSmi_1433(state_, TNode<Context>{tmp96}, TNode<Object>{tmp106});
...
TNode<Object> RegExpPrototypeSearchBodySlow_332(compiler::CodeAssemblerState* state_, TNode<Context> p_context, TNode<JSReceiver> p_regexp, TNode<String> p_string) {
  ...
  if (block7.is_used()) {
    ...
    USE(tmp52);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp52 = Cast20ATFastJSRegExpResult_1491(state_, TNode<Context>{tmp45}, TNode<Object>{tmp50}, &label0);
...
USE(parameter1);
  ...
  if (block0.is_used()) {
    ...
    USE(tmp3);
    tmp3 = UnsafeCast10JSReceiver_1480(state_, TNode<Context>{tmp0}, TNode<Object>{tmp1});
  ...
  if (block1.is_used()) {
    ...
    USE(tmp11);
    tmp11 = UnsafeCast8JSRegExp_1492(state_, TNode<Context>{tmp6}, TNode<Object>{tmp9});
    TNode<Object> tmp12;
