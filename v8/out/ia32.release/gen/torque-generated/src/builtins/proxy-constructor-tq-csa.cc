...
USE(parameter2);
  ...
  if (block6.is_used()) {
    ...
    tmp17 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp12}, TNode<Object>{tmp15}, &label0);
  ...
  if (block10.is_used()) {
    ...
    USE(tmp44);
    compiler::CodeAssemblerLabel label0(&ca_);
    tmp44 = Cast10JSReceiver_1427(state_, TNode<Context>{tmp38}, TNode<Object>{tmp42}, &label0);
