...
class TqJSRegExpResult : public TqJSArray {
 public:
  ...
  uintptr_t GetCachedIndicesOrMatchInfoAddress() const;
  Value<uintptr_t> GetCachedIndicesOrMatchInfoValue(d::MemoryAccessor accessor ) const;
...
class TqJSV8BreakIterator : public TqJSObject {
 public:
  ...
  uintptr_t GetBreakIteratorTypeAddress() const;
  Value<uintptr_t> GetBreakIteratorTypeValue(d::MemoryAccessor accessor ) const;
};
