...
TFS(GetIteratorWithFeedback, kReceiver, kLoadSlot, kCallSlot, kFeedback) \
TFS(CallIteratorWithFeedback, kReceiver, kIteratorMethod, kCallSlot, kFeedback) \
...
TFS(RegExpPrototypeExecSlow, kRegexp, kString) \
...
TFS(RegExpSearchFast, kReceiver, kString) \
